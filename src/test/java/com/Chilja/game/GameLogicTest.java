...
import com.Chilja.game.Set;
import com.Chilja.game.GameLogic;
...
class GameLogicTest {
	...
	public void setUp() {
		...
		maxSpeed = 140;
		horsepower  = 548;
		card1 = new Card(brand, model, displacement, zeroToHundred, maxSpeed, horsepower);
		...
		maxSpeed = 278;
		horsepower  = 431;
		card2 = new Card(brand, model, displacement, zeroToHundred, maxSpeed, horsepower);
		...
		maxSpeed = 250;
		horsepower  = 568;
		card3 = new Card(brand, model, displacement, zeroToHundred, maxSpeed, horsepower);
		...
		maxSpeed = 290;
		horsepower  = 466;
		card4 = new Card(brand, model, displacement, zeroToHundred, maxSpeed, horsepower);
		...
		maxSpeed = 320;
		horsepower  = 717;
		card5 = new Card(brand, model, displacement, zeroToHundred, maxSpeed, horsepower);
		...
		maxSpeed = 262;
		horsepower  = 464;
		card6 = new Card(brand, model, displacement, zeroToHundred, maxSpeed, horsepower);
	}
	...
	public void sameValuesMakeCardsEqual() {
		...
		maxSpeed = 140;
		horsepower  = 548;
		Card card7 = new Card(brand, model, displacement, zeroToHundred, maxSpeed, horsepower);
